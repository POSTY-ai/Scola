const quizData = [
    {
        question: "En quelle année la Société des Nations a-t-elle officiellement commencé ses activités ?",
        answers: ["1918", "1919", "1920", "1921"],
        correct: 2
    },
    {
        question: "Quel traité contient le « Covenant » de la Société des Nations ?",
        answers: [
    ...
    {
        question: "Quel était l’un des objectifs principaux de la Société des Nations ?",
        answers: [
            "Encourager l’armement massif des États membres",
            "Mettre en place un marché commun européen",
            "Prévenir les guerres par la sécurité collective et l’arbitrage",
            "Favoriser l’expansion coloniale"
        ],
        correct: 2
    },
    {
        question: "Quel pays-puissance importante n’a jamais adhéré à la Société des Nations ?",
        answers: ["États-Unis", "Royaume-Uni", "France", "Italie"],
        correct: 0
    },
    {
        question: "Quel était un des graves handicaps de la Société des Nations ?",
        answers: [
            "Elle disposait d’une armée permanente fixe",
            "Elle exigeait l’unanimité pour de nombreuses décisions",
            "Elle imposait des sanctions financières sans aucun soutien",
            "Elle contrôlait directement les médias de chaque membre"
        ],
        correct: 1
    },
    {
        question: "Quel est le siège (ville) principal de la Société des Nations ?",
        answers: ["Paris", "Londres", "Genève", "New York"],
        correct: 2
    },
    {
        question: "Quelle crise emblématique a révélé l’incapacité de la Société des Nations à agir efficacement ?",
        answers: [
            "La crise de Cuba (1962)",
            "La crise de Manchourie (1931)",
    ...
    {
        question: "Pendant quelle période la Société des Nations a-t-elle cessé d’exister officiellement ?",
        answers: ["1939", "1942", "1946", "1950"],
        correct: 2
    },
    {
        question: "Quel organisme international a succédé à la Société des Nations après la Seconde Guerre mondiale ?",
        answers: ["Union européenne", "Organisation mondiale du commerce", "Organisation des Nations unies", "Organisation du traité de l’Atlantique nord"],
        correct: 2
    },
    {
        question: "Quel domaine non militaire la Société des Nations a-t-elle réussi à influencer positivement ?",
        answers: [
            "Le développement de missiles intercontinentaux",
            "La protection des réfugiés et la lutte contre le trafic de drogue",
            "La domination économique d’un bloc géopolitique",
            "L’agrandissement des empires coloniaux"
        ],
        correct: 1
    }
];
...
class WWIQuiz {
    ...
    showResults() {
        ...
        if (percentage >= 90) {
            ...
            resultsMessage.textContent = 'Excellent ! Vous maîtrisez parfaitement la SDN!';
        } else if (percentage >= 70) {
            resultsIcon.className = 'fas fa-medal results-icon good';
            resultsMessage.textContent = 'Très bien ! Vous avez de bonnes connaissances sur la SDN.';
        } else if (percentage >= 50) {
            resultsIcon.className = 'fas fa-award results-icon average';
            resultsMessage.textContent = 'Pas mal ! Il y a encore quelques points à réviser sur la SDN.';
        } else {
            resultsIcon.className = 'fas fa-book results-icon poor';
            resultsMessage.textContent = 'Il serait bon de réviser davantage sur la SDN.';
        }
